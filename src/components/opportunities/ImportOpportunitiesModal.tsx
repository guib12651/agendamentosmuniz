...
export default function ImportOpportunitiesModal({ isOpen, onClose, onSuccess }: ImportOpportunitiesModalProps) {
  ...
  /**
   * Comprime a imagem antes de enviar ao OCR.
   * Reduz drasticamente os tokens de visão consumidos (menos créditos por importação).
   * Em caso de falha, faz fallback para o arquivo original.
   */
